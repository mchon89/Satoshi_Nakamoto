...
author = [timothy_may, nick_szabo, ian_grigg, hal_finney]
author_name = ["timothy_may", "nick_szabo", "ian_grigg", "hal_finney"]

full = os.getcwd() + '/other_data/'
...
for i in range(len(author)):
	for j in range(len(author[i])):
		...
		article.download()
		article.parse()
		with open(full + '{}-{}.txt'.format(author_name[i],j), 'w') as f:
